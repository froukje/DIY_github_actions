...
def test_preprosessing():
    features = [4.668102, 193.681735, 47580.991603, 7.166639, 359.948574, \
            526.424171, 13.894419, 66.687695, 4.435821]

    actual_preprocessed = make_predictions.preprocessing(features)
    expected_preprocessed = np.array([-1.69398477e+00,-5.66407442e-02, 2.95701968e+00, \
            -1.21711995e-02, 7.22710255e-01, 1.23380913e+00, -1.06104008e-01, \
            1.45083389e-03, 6.13677488e-01])
